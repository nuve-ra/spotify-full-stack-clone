    ...
    return(
        ...
        <div className="w-full flex flex-row justify-between items-center font-semibold ">
            ...
            <div className="flex items-center gap-4">
                ...
                <p onClick={handleAdminRedirect} className="bg-purple-500 text-black h-7 w-7 py-1 rounded-full text-[15px] flex items-center justify-center cursor-pointer">N</p>
            </div>
        </div>
